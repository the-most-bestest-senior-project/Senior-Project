...
def main():
        ...
        os.system("cd tf/ec2 && terraform init && terraform apply -var 'aws_access_key='%s -var 'aws_secret_key='%s -var 'latest_snapshot='%s -var 'vpc_id='%s -var 'subnet_id='%s -auto-approve" % (access_key, secret_key, snap, vpc_id, sub))
